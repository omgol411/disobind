...
def get_inteface_params_dict( model_version: int ) -> Dict:
	if model_version == 23:
		...
		interface_param = {
			...
			"cg_5": [
				"Epsilon_3_17.1",
				"model_global-[128, 'ln2', True, 1, '']_[0, 0, 0, 0, 'vanilla', '']_['elu', None]_0.0002_0.5_[0.9, 3]_[0.2, 0, 0, 0, 0]_0.05_0.92__0"
				# "Epsilon_3_14.1",
			...
			"cg_10": [
				"Epsilon_3_17.2",
				"model_global-[128, 'ln2', True, 1, '']_[0, 0, 0, 0, 'vanilla', '']_['elu', None]_0.0002_0.5_[0.9, 3]_[0.2, 0, 0, 0, 0]_0.05_0.89__0"
				# "Epsilon_3_14.2",
